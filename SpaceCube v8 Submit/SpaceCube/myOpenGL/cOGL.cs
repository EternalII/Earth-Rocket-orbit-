...
namespace OpenGL
{
    class cOGL
    {
        ...
        void DrawFloor()//draw reflection floor
        {
        ...
        {
            float cubeSize = 15; // to easily modify the size of skybox. At 20 edges don't render.
